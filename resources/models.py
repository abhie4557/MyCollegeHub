...
resources_assignment= db['resources_assignment']

def get_upload_path(instance, filename):
    print(instance.course)
    return os.path.join(str(instance.course),'Papers', str(instance.year), filename)
...
class Paper(models.Model):
    ...
    pdf_file = models.FileField(upload_to=get_upload_path)  # Use the custom upload path function
